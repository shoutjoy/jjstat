#' plspm_edge_position
#'
#' @param semPaths_plot plot data generated from a PLS-PM model.
#' @param ... triples of arguments specifying `from` node, `to` node, and `new_position`.
#' @param plot logical, if `TRUE`, the plot will be displayed with updated edge positions. Default is `TRUE`.
#'
#' @return Modified plot object with updated edge positions.
#' @export
#'
#' @examples
#'
