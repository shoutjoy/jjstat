...
#'                                 se3 = 0.0785669))
#' # Example usage
#' coefficients1 <- c("IMAG -> EXPE" = 0.578959128, "EXPE -> SAT" = -0.002753995, "SAT -> LOY" = 0.495479322)
...
#' coefficients3 <- c(imag2expe = 0.578959128, expe2sat = -0.002753995, sat2loy = 0.495479322)
...
#'
#'
sobel_test_extend <- function(coefficients, se_values, show=TRUE) {
